document.addEventListener('DOMContentLoaded', function() {
  ...
  vid.volume = 0.05;
  // var videomobile = "assets/videos/video-mobile.mp4";

  document.addEventListener('touchstart',function(){
    vid.play();
  },true);

  evt.initMouseEvent( "touchstart", true,true,window,0,0,0,0,0,false,false,false,false,0, true );
  ...
  //   // $(vid).play();
  //   // var mp4source = document.getElementById("srcmp4");
  //   // $(mp4source).attr('src', videomobile);
